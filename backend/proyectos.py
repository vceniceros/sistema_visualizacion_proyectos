...
class Proyecto:
    def __init__(self, id_proyecto, nombre, imagen, descripcion, ubicacion, tipo_inmueble, tipo_contrato, precio, ancho, largo):
...
def proyectos_test():
    proyecto = Proyecto(1, "prueba", "prueba", "prueba", "prueba de ubicacion", "prueba", "prueba", 100, 38, 25)
